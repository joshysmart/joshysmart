const Header = () => {
  return (
    <header className="p-6 md:p-8 xl:px-40 xl:pr-44 flex flex-col items-center space-y-6 md:justify-between md:flex-row md:space-y-0 z-10 relative lg:min-w-full">
      ...
      <section className="social-icons flex space-x-6 items-center">
        ...
        <a href="https://www.frontendmentor.io/profile/joshysmart" aria-label="my front-end mentor profile">
        ...
        <a href="https://www.linkedin.com/in/joshysmart/" aria-label="my linkedin profile">
        ...
        <a href="https://twitter.com/saniojoshua" aria-label="my twitter profile">
