const Bookmark = (props: {tech:string[], bookmark:string, website:string}) => {
  return (
    <section className="flex flex-col items-center justify-between lg:items-start lg:w-2/5 px-4 md:px-8 lg:p-0">
      ...
      <a href={props.website} className="text-pureWhite border-b-2 border-lightGreen pb-3 text-base font-bold hover:text-lightGreen tracking-[.14em] mt-5">VISIT WEBSITE</a>
    </section>
  )
}
